export type { TResponseWithId, TSendCodeRespons, TWithMessageResponse, } from "./auth";
export type { IClient, TGender } from "./user";
export type { TCard } from "./card";
export type { TCarouselItem, TBonus, TBonusIcon, TCardMotivationItem, TProposalItem, } from "./content";
